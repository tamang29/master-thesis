...
Collaborative modeling introduced another challenge. Participants could edit the same diagram, but they received limited collaboration awareness about the presence, focus, and selections of other collaborators. This made it harder to coordinate work and understand changes during standalone shared modeling and Artemis team modeling sessions.
