...
Additional feedback came from educational use. Students used Apollon in teaching contexts such as the introductory course and iPraktikum,#footnote[TUM iPraktikum project website: #link("https://aet.cit.tum.de/projects/ipraktikum/")[aet.cit.tum.de/projects/ipraktikum].] modeling exercises, and project-related work. Instructors, tutors, and Artemis developers encountered the tool through exercise creation, assessment, quiz generation, collaboration, and integration work.
...
The implementation addressed part of this issue through the editor-side modernization described in #section-link(<impl-ui-modernization>). The editor-facing work replaced parts of the older MUI and Emotion usage with lighter reusable primitives and adapted popovers, selection controls, tooltips, and style-editing components to the newer component approach. It also included cleanup of wrapper components, icon usage, related styles, package configuration, and tests.
...
The strongest concern was edge interaction. Feedback repeatedly returned to edge straightness, anchor points, layout, selectable areas, and label placement. The subsequent implementation addressed these concerns through the edge refactor, line-jump behavior, improved hit areas and anchor handling, compact routing, manual label placement, and direct control over line segments and connection points.
