...
The strongest concern was edge interaction. Feedback repeatedly returned to edge straightness, anchor points, layout, and selectable areas. Based on this feedback, edge usability has been improved and requires less interaction cost than before. The implemented edge refactor and line-jump behavior improved important parts of the experience, along with direct control over line segments and connection points.
