...
#table(
  ...
  [Objectives], [Ravi Tamang and Fady Samaan],
  [Outline], [Fady Samaan],
  [Background], [Fady Samaan],
  [Related Work], [Ravi Tamang and Fady Samaan],
  [Requirements], [Ravi Tamang],
  [Architecture], [Ravi Tamang],
  [Implementation], [Ravi Tamang and Fady Samaan],
  [User Feedback and Findings], [Fady Samaan],
  [Summary], [Fady Samaan],
  [Future Work], [Fady Samaan],
)
